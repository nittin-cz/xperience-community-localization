...
internal class LocalizationModuleInstaller
{
    ...
    public void InstallLocalizationKeyInfo(ResourceInfo resource)
    {
        ...
        formItem = new FormFieldInfo
        {
            Name = nameof(LocalizationKeyInfo.LocalizationDescription),
            AllowEmpty = true,
            Visible = true,
            Precision = 0,
            DataType = "longtext",
    ...
    public void InstallLocalizationTranslationInfo(ResourceInfo resource)
    {
        ...
        formItem = new FormFieldInfo
        {
            Name = nameof(LocalizationTranslationInfo.LocalizationTranslationLocalizationKeyId),
            AllowEmpty = false,
            Visible = true,
            Precision = 0,
            DataType = "integer",
        ...
        formItem = new FormFieldInfo
        {
            Name = nameof(LocalizationTranslationInfo.LocalizationTranslationContentLanguageId),
            AllowEmpty = false,
            Visible = true,
            Precision = 0,
            DataType = "integer",
        ...
        formItem = new FormFieldInfo
        {
            Name = nameof(LocalizationTranslationInfo.LocalizationTranslationText),
            AllowEmpty = true,
            Visible = true,
            Precision = 0,
            DataType = "longtext",
